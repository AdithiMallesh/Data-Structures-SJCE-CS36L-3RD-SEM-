/*Define a structure called Student with the members: name, reg_no, marks
in 3 tests and average_ marks.
...
students information c) to calculate the average of best two test marks of
each student.
