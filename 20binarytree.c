/*20.	Develop a menu driven program to implement Binary Tree/Binary search tree to perform the following operations.

    i)Insertion   ii)  Traversing in different order(Depth first Traversal)    iii)  Search and display the node and its parent node.    iv)  Count No of nodes.
*/
#include<stdio.h>
#include<stdlib.h>
#include<string.h>
    ...
    while(1){
        ...
        switch(choice){
            ...
            case 3: printf("Enter the info of the node to be searched:");
                    ...
                    break;
            case 4: printf("number of nodes in tree: %d\n",NODES(root));
                    break;
