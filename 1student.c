/*1.	Define a structure to represent student with the attributes stud-id, name, marks in 3 subjects.  Create array of students  by allocating memory dynamically and Implement the following operations 
i)	Insert Student ii) Delete student iii) Search for a student with highest marks in each subject and display the information of that student.
*/
#include<stdio.h>
#include<stdlib.h>
#include<string.h>
