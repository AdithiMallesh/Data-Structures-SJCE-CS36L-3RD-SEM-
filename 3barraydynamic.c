/*3.Develop a menu driven program to implement various operations on array
storage representation with  dynamic memory allocation. */
#include<stdio.h>
#include<stdlib.h>
#include<conio.h>

int last_index=-1,capacity;
